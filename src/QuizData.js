const questions = [
    ...
    {
        text: "A computer cannot boot if it does not have the",
        options: [
            { id: 0, opt: "a", text: "Compiler", isCorrect: false },
            { id: 1, opt: "b", text: "Loader", isCorrect: false },
            { id: 2, opt: "c", text: "Operating system", isCorrect: true },
            { id: 3, opt: "d", text: "Assembler", isCorrect: false }
        ]
    },
    {
        text: "Which of the following is a popular programming language for developing multimedia webpages.",
        options: [
            { id: 0, opt: "a", text: "COBOL", isCorrect: false },
            { id: 1, opt: "b", text: "JAVA", isCorrect: true },
            { id: 2, opt: "c", text: "BASIC", isCorrect: false },
            { id: 3, opt: "d", text: "Assembler", isCorrect: false }
        ]
    },
    {
        text: "Where is RAM located?",
        options: [
            { id: 0, opt: "a", text: "Mother Board", isCorrect: true },
            { id: 1, opt: "b", text: "Expansion Board", isCorrect: false },
            { id: 2, opt: "c", text: "External Drive", isCorrect: false },
